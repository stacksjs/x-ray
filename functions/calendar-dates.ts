...
const dayName = ref(new Date(`${currentYear}-${currentMonth}-${currentDay}`).toLocaleString('default', { weekday: 'long' }))
...
function nextDay(): void {
  ...
  currentDateString = useDateFormat(currentDateString, 'YYYY-MM-DD').value
  ...
  dayName.value = new Date(`${currentYear}-${currentMonth}-${currentDay}`).toLocaleString('default', { weekday: 'long' })
